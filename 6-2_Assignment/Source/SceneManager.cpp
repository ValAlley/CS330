...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 1.0f, 0.01f, 0.01f);
	...
	m_pShaderManager->setFloatValue("lightSources[1].focalStrength", 62.0f);
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 0.2f);

	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, 0.0f, 6.0f);

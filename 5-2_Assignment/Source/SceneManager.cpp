...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("Textures/Tiles.jpg", "Tiles");

	bReturn = CreateGLTexture("Textures/Tile.jpg", "Tile");

	bReturn = CreateGLTexture("Textures/Fabrics.jpg", "Fabrics");

	bReturn = CreateGLTexture("Textures/Metal.jpg", "Metal");

	bReturn = CreateGLTexture("Textures/Wood.jpg", "Wood");

	bReturn = CreateGLTexture("Textures/Wood2.jpg", "Wood2");

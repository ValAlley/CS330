...
*  LoadSceneTextures()
*
*  This is used for preparing the 3D scene by loading
...
void SceneManager::SetupSceneLights()
{
	...
	// LIGHT 0: High Overhead Desk Light (RED)
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 0.0f, 0.0f);
	...
	// LIGHT 1: Low Left-Side Fill Light (GREEN)
	m_pShaderManager->setVec3Value("lightSources[1].position", 1.0f, 2.0f, 5.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.05f, 0.05f, 0.05f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.0f, 1.0f, 0.0f);
	...
	// LIGHT 2: Distant Right-Side Front Light (BLUE)
	...
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.0f, 0.0f, 1.0f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.5f, 1.25f, 2.0f);
	...
	//Box(Keyboard)
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 0.5f, 7.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.5f, 0.5f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.5f, 0.0f, 0.0f);

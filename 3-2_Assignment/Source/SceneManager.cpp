...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.192, 0.788, 1, 0.313);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 2.0f, 5.0f);
	...
	// set the color values into the shader
	SetShaderColor(0.168, 0.498, 1, 0.8);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 6.0f, 5.0f);
	...
	// set the color values into the shader
	SetShaderColor(0.964, 0.21, 1.0, 0.607);
	...
	// set the color values into the shader
	SetShaderColor(0.72, 0.20, 1, 350);
	...
	// set the color values into the shader
	SetShaderColor(0.905, 0.094, 1, 30);

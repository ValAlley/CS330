...
// --- Camera Attributes ---
// Initial camera position pulled slightly back to view the scene
...
// --- Camera Angles ---
// Yaw is initialized to -90.0 degrees so it points towards the -Z axis
float yaw = -90.0f;
float pitch = 0.0f;

// --- Mouse Tracking ---
bool firstMouse = true;
// Assuming an 800x600 window; center the initial mouse coordinates
float lastX = 800.0f / 2.0;
float lastY = 600.0f / 2.0;

// --- Timing and Speed ---
// Time between current frame and last frame to ensure consistent movement speed
float deltaTime = 0.0f;
float lastFrame = 0.0f;
// Base movement speed, which will be modified by the scroll wheel
